...
public class CG1Visitor extends Visitor
{
    ...
    private void setOffsets(ClassDecl c)
    {
        ...
        if(c.superLink != null)
        {
            objCount = c.superLink.numObjFields;
            dataCount = c.superLink.numDataFields;
        }
        ...
        c.numObjFields = objCount;
        c.numDataFields = dataCount;
    ...
    private void setParamOffsets(MethodDecl m)
    {
        int offset = 4;
        for(int i = m.params.size() - 1; i >= 0; i--)
        {
            ...
            param.offset = offset;
            offset += slotSize(param.type);
        }
        m.paramSize = offset - 4;
    }
