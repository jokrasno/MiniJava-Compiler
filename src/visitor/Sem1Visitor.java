...
public class Sem1Visitor extends Visitor
{
    ...
    public Object visit(MethodDecl n)
    {
        ...
        // if the class environment already contains the method, return a duplicate 
    ...
    {
        // check if there are duplicates here
        ...
        // we reported errors, but don't want cascading nonsense so set it 
